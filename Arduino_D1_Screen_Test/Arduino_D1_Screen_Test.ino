...
/*
  ...
  U8glib示例概述：
    帧缓冲区示例：clearBuffer / sendBuffer。快速，但可能无法使用所有Arduino板，因为RAM消耗
    页面缓冲区示例：firstPage / nextPage。较少的RAM使用，应该与所有Arduino板卡配合使用。
    U8x8仅文本示例：无RAM使用，与显示控制器直接通信。没有图形，只有8x8文字。
*/

// Please UNCOMMENT one of the contructor lines below
// U8g2 Contructor List (Frame Buffer)
// The complete list is available here: https://github.com/olikraus/u8g2/wiki/u8g2setupcpp
// Please update the pin numbers according to your setup. Use U8X8_PIN_NONE if the reset pin is no
